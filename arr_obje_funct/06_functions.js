...
console.log(multiplytwonum(8, 6))

const userlogged = {
    username: 'prince-gehlot',
    id: 2,
    graduation: 'mca2024-2025'
}
function logged(log) {
    console.log(`username is ${log.username} the id of ${log.id} and the graduation completed in the year ${log.graduation}`);
